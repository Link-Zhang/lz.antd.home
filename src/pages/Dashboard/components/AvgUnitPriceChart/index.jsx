...
class AvgUnitPriceChart extends React.PureComponent {
    render() {
        return (
            <Card hoverable title={'平均单价'} size={'small'}>
                <ResponsiveContainer width={'100%'} height={250}>
                    <LineChart data={data} margin={{top: 0, right: 5, left: 5, bottom: 0}} syncId={'chartSyncId'}>
                        ...
                        <Line yAxisId={'left'} type={'monotone'} dataKey={'pv'} stroke={'#73D13D'} connectNulls
...
export default AvgUnitPriceChart;
